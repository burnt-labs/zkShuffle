...
/// Convert Uint256 to decimal string for proof serialization
fn uint256_to_string(val: &Uint256) -> String {
    // Uint256 already implements Display to show the decimal value
    val.to_string()
}

/// Convert our Groth16Proof format to SnarkJS-compatible format
